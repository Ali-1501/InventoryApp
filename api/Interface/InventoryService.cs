...
public class InventoryService : IInventoryService
{
    ...
    public InventoryService(ILogger<InventoryService> logger, InventoryManagementSystemContext context)
    {
        _logger = logger;
        _context = context;
    }
    ...
    {
        ApiResponse res = new();
        var isDuplicate = _context.Purchases.SingleOrDefault(x => x.InvoiceNumber.ToLower() == obj.InvoiceNumber.ToLower());
